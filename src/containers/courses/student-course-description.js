...
import StudentCourseCard from './student-session-card';

const API_FOR_STUDENT_COURSES = `${process.env.REACT_APP_RESTAPI_URL}:${
  process.env.REACT_APP_RESTAPI_PORT
}/studentCourses`;

const getStudent = id => {
  console.log('API_FOR_STUDENT_COURSES: ', API_FOR_STUDENT_COURSES);
    return `${API_FOR_STUDENT_COURSES}/?Enrolment__r.Id=${id}`;
};
